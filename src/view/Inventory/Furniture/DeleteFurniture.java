 ...
 * @author Nipuni
 */
public class DeleteFurniture extends javax.swing.JInternalFrame {
     ...
     */
    public DeleteFurniture(JDesktopPane jdp) {
            initComponents();
            //setSize(Toolkit.getDefaultToolkit().getScreenSize());
            
            dtm1=(DefaultTableModel) infoTable2.getModel();
            
            infoTable2.setModel(FurnitureController.getAllFurnitureList_2());
    }
            ...
            .addGroup(AddPanelLayout.createSequentialGroup()
                ...
                .addGroup(AddPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(AddPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(PriceText, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        int respond= JOptionPane.showConfirmDialog(DeleteFurniture.this,"Do you want to delete this record.? If yes click Yes", "Confimation message",0,3);

        if(respond==JOptionPane.OK_OPTION){
            try {
                String itemCode=ItemCodeText.getText();
                int res=FurnitureController.deleteFurniture(itemCode);

                if(res>0){
                    JOptionPane.showMessageDialog(DeleteFurniture.this,"Selected record deleted", "Information", 1);
                    ...
                    JOptionPane.showMessageDialog(DeleteFurniture.this,"Deleting process unsuccessful", "Information", 1);
                }
                ...
                Logger.getLogger(DeleteFurniture.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{}
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        if(itemcode2!=null){
                ArrayList<String> itemList=FurnitureController.SearchItem(itemcode2);

                NameText.setText(itemList.get(0));
                QtyText.setText(itemList.get(2));
                LocationText.setText(itemList.get(1));
                purDateText.setText(itemList.get(5));
                WarrantyPeriodText.setText(itemList.get(7));
                periodText.setText(itemList.get(9));
                UserText.setText(itemList.get(4));
                SellerNameText.setText(itemList.get(8));
                PriceText.setText(itemList.get(3));
                methodText.setText(itemList.get(6));
            ...
            JOptionPane.showMessageDialog(DeleteFurniture.this,"AnError occured", "Information", 1);
        }
