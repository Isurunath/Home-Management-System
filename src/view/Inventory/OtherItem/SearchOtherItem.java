 ...
 * @author Nipuni
 */
public class SearchOtherItem extends javax.swing.JInternalFrame {

    /**
     * Creates new form SearchElectricGoods
     */
    public SearchOtherItem(JDesktopPane jdp) {
        initComponents();
           NameLocationPanel.setVisible(false);
           NameSellerPanel.setVisible(false);
           
          List name=OtherItemController.getOtherItemName();
          ...
          UsageComboBox.removeAllItems();
           
           for(Object o:name){
               UsageComboBox.addItem(o);
           }
           
           List location=OtherItemController.getOtherItemLocation();
    ...
    private void initComponents() {
        ...
        ResponseComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "--Select Option--", "Name", "Name & Location", "Usage", " " }));
        ...
        NameLocationPanelLayout.setHorizontalGroup(
            ...
            .addGroup(NameLocationPanelLayout.createSequentialGroup()
                ...
                .addGroup(NameLocationPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(NameComboBox, 0, 140, Short.MAX_VALUE)
        ...
        NameSellerPanelLayout.setVerticalGroup(
            ...
            .addGroup(NameSellerPanelLayout.createSequentialGroup()
                ...
                .addGroup(NameSellerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(UsageComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(AddPanelLayout.createSequentialGroup()
                .addGroup(AddPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(AddPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ResponseComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(AddPanelLayout.createSequentialGroup()
                        .addGap(222, 222, 222)
        ...
        AddPanelLayout.setVerticalGroup(
            ...
            .addGroup(AddPanelLayout.createSequentialGroup()
                ...
                .addComponent(NameLocationPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel1, 974, 974, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if("Name".equals(clientResponse)){
            try {
                ...
                infoTable3.setModel(OtherItemController.searchOtherItemByName(name));
            } catch (HibernateException ex) {
                Logger.getLogger(SearchOtherItem.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            try {
                ...
                infoTable3.setModel(OtherItemController.searchOtherItemByNameAndLocation(name, location));
                } catch (HibernateException ex) {
                Logger.getLogger(SearchOtherItem.class.getName()).log(Level.SEVERE, null, ex);
            }       
        }else if("Usage".equals(clientResponse)){
            try {
                String usage=String.valueOf(UsageComboBox.getSelectedItem());
                
                infoTable3.setModel(OtherItemController.searchOtherItemByUsage(usage));
                } catch (HibernateException ex) {
                Logger.getLogger(SearchOtherItem.class.getName()).log(Level.SEVERE, null, ex);
            }       
        }
