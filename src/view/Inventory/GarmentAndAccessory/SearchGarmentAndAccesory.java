 ...
 * @author Nipuni
 */
public class SearchGarmentAndAccesory extends javax.swing.JInternalFrame {

    /**
     * Creates new form SearchElectricGoods
     */
    public SearchGarmentAndAccesory(JDesktopPane jdp) {
        initComponents();
           NameLocationPanel.setVisible(false);
           NameSellerPanel.setVisible(false);
           
          List name=GarmentAndAccesoryController.getGarmentAndAccesoryName();
          ...
          NameComboBox1.removeAllItems();
           ...
           List location=GarmentAndAccesoryController.getGarmentAndAccesoryLocation();
           ...
           List sellers=GarmentAndAccesoryController.getGarmentAndAccesorySellers();
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(1073, 580));
        ...
        NameSellerPanelLayout.setHorizontalGroup(
            ...
            .addGroup(NameSellerPanelLayout.createSequentialGroup()
                ...
                .addGroup(NameSellerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(SellerComboBox, 0, 143, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(AddPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 270, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
       String clientResponse=String.valueOf(ResponseComboBox.getSelectedItem());
        ...
        if("Name".equals(clientResponse)){
                ...
                infoTable3.setModel(GarmentAndAccesoryController.searchGarmentandaccesoryByName(name));
        }else if("Name & Location".equals(clientResponse)){
                String name=String.valueOf(NameComboBox.getSelectedItem());
                String location=String.valueOf(LocationComboBox.getSelectedItem());
                
                infoTable3.setModel(GarmentAndAccesoryController.searchGarmentandaccesoryByNameAndLocation(name, location));

        }else if("Name of Seller".equals(clientResponse)){
                String seller=String.valueOf(SellerComboBox.getSelectedItem());
                
                infoTable3.setModel(GarmentAndAccesoryController.searchGarmentAndAccessoryByNameOfSeller(seller));

        }else if("Name & Name of Seller".equals(clientResponse)){
                String name=String.valueOf(NameComboBox1.getSelectedItem());
                String seller=String.valueOf(SellerComboBox.getSelectedItem());
                
                infoTable3.setModel(GarmentAndAccesoryController.searchGarmentAndAccessoryByNameAndNameOfSeller(name, seller));
