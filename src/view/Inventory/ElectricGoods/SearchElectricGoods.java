 ...
 * @author Nipuni
 */
public class SearchElectricGoods extends javax.swing.JInternalFrame {

    /**
     * Creates new form SearchElectricGoods
     */
    public SearchElectricGoods(JDesktopPane jdp) {
        initComponents();
           NameLocationPanel.setVisible(false);
           NameBrandPanel.setVisible(false);
           NameSellerPanel.setVisible(false);
           
           List name=ElectricGoodController.getElectrcItemName();
          ...
          NameComboBox1.removeAllItems();
           ...
           List location=ElectricGoodController.getElectrcItemLocation();
           ...
           List seller=ElectricGoodController.getElectricGoodSellers();
           ...
           List brand=ElectricGoodController.getElectricGoodBrands();
           
           BrandComboBox.removeAllItems();
           
           for(Object o:brand){
               BrandComboBox.addItem(o);
           }
    ...
    private void initComponents() {
        ...
        ResponseComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "--Select Option--", "Name", "Name & Location", "Name of Seller", "Name & Name of Seller", "Brand", " " }));
        ...
        NameLocationPanelLayout.setHorizontalGroup(
            ...
            .addGroup(NameLocationPanelLayout.createSequentialGroup()
                ...
                .addGroup(NameLocationPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(NameComboBox, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(LocationComboBox, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        NameSellerPanelLayout.setHorizontalGroup(
            ...
            .addGroup(NameSellerPanelLayout.createSequentialGroup()
                ...
                .addGroup(NameSellerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(NameComboBox1, 0, 126, Short.MAX_VALUE)
        ...
        NameBrandPanelLayout.setHorizontalGroup(
            ...
            .addGroup(NameBrandPanelLayout.createSequentialGroup()
                ...
                .addComponent(BrandComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        NameBrandPanelLayout.setVerticalGroup(
            ...
            .addGroup(NameBrandPanelLayout.createSequentialGroup()
                ...
                .addGroup(NameBrandPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(BrandComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
                ...
                .addGroup(AddPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(AddPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(AddPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(NameBrandPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(AddPanelLayout.createSequentialGroup()
                ...
                .addGroup(AddPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(AddPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(NameBrandPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(NameSellerPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void SearchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchButtonActionPerformed
        ...
        if("Name".equals(clientResponse)){
            try {
                infoTable3.removeAll();
                String name=String.valueOf(NameComboBox.getSelectedItem());
                
                infoTable3.setModel(ElectricGoodController.searchElectricItemByName(name));
            ...
            try {
                ...
                infoTable3.setModel(ElectricGoodController.searchElectricGoodByNameOfSeller(seller));
            } catch (HibernateException ex) {
                Logger.getLogger(SearchElectricGoods.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            try {
                ...
                infoTable3.setModel(ElectricGoodController.searchElectricGoodByNameAndNameOfSeller(name, seller));
            } catch (HibernateException ex) {
                Logger.getLogger(SearchElectricGoods.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            try {
                ...
                infoTable3.setModel(ElectricGoodController.searchElectricItemByNameAndLocation(name, location));
            } catch (HibernateException ex) {
                Logger.getLogger(SearchElectricGoods.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else if("Brand".equals(clientResponse)){
            try {
                infoTable3.removeAll();
                String brand=String.valueOf(BrandComboBox.getSelectedItem());
                
                infoTable3.setModel(ElectricGoodController.searchElectricGoodByBrand(brand));
            } catch (HibernateException ex) {
                Logger.getLogger(SearchElectricGoods.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void ResponseComboBoxMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ResponseComboBoxMouseClicked
        ...
        }else if("Brand".equals(userInput)){
            NameLocationPanel.setVisible(false);
