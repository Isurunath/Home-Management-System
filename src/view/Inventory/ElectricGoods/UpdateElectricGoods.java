 ...
 * @author Nipuni
 */
public class UpdateElectricGoods extends javax.swing.JInternalFrame {
    
    DefaultTableModel dtm3;
    /**
     * Creates new form UpdateElectricGoods
     */
    public UpdateElectricGoods(JDesktopPane jdp) {
        try {
            initComponents();
            ...
            dtm3=(DefaultTableModel) infoTable3.getModel();
            
            infoTable3.setModel(ElectricGoodController.getAllElectricGoodsList_2());
        } catch (HibernateException ex) {
            Logger.getLogger(UpdateElectricGoods.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Update Electrical Item");
            ...
            .addGroup(AddPanelLayout.createSequentialGroup()
                ...
                .addGroup(AddPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(AddPanelLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(SellerNameText, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, AddPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(AddPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, AddPanelLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(AddPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(PaymentPeriodText, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(InputPowerText, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(PaymentMethodText, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(257, 257, 257))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, AddPanelLayout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPanel1, 1068, 1068, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        int respond= JOptionPane.showConfirmDialog(UpdateElectricGoods.this,"Do you want to Update this record.? If yes click Yes", "Confimation message",0,3);
        ...
        if(respond==JOptionPane.OK_OPTION){
            try {
                ...
                String power=InputPowerText.getText();
                ...
                ElectricalGoods electricGoods=new ElectricalGoods(itemCode, name, location, qty, user, inputPower, brand, nameOfTheSeller,purDate, price, paymentMethod, paymentPeriod);
                boolean res=ElectricGoodController.EditElectricGood(electricGoods);
                
                if(res==true){
                    try {
                        JOptionPane.showMessageDialog(UpdateElectricGoods.this,"Selected Record updated", "Information", 1);
                    ...
                    JOptionPane.showMessageDialog(UpdateElectricGoods.this,"An Error Occured", "Information", 1);
                }
            } catch (HibernateException ex) {
                Logger.getLogger(UpdateElectricGoods.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
                JOptionPane.showMessageDialog(UpdateElectricGoods.this,"User cancel the process", "Information", 1);
                }
    ...
    private void infoTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_infoTable3MouseClicked
           dtm3=ElectricGoodController.getAllElectricGoodsList_2();
           
            ItemCodeText.setText(String.valueOf(dtm3.getValueAt(infoTable3.getSelectedRow(), 0)));
            NameText.setText(String.valueOf(dtm3.getValueAt(infoTable3.getSelectedRow(), 1)));
            QtyText.setText(String.valueOf(dtm3.getValueAt(infoTable3.getSelectedRow(), 3)));
            LocationText.setText(String.valueOf(dtm3.getValueAt(infoTable3.getSelectedRow(), 2)));
            BrandText.setText(String.valueOf(dtm3.getValueAt(infoTable3.getSelectedRow(), 6)));
            SellerNameText.setText(String.valueOf(dtm3.getValueAt(infoTable3.getSelectedRow(), 7)));
            InputPowerText.setText(String.valueOf(dtm3.getValueAt(infoTable3.getSelectedRow(), 5)));
            UserText.setText(String.valueOf(dtm3.getValueAt(infoTable3.getSelectedRow(), 4)));
            PriceText.setText(String.valueOf(dtm3.getValueAt(infoTable3.getSelectedRow(), 9)));
            PaymentMethodText.setText(String.valueOf(dtm3.getValueAt(infoTable3.getSelectedRow(), 10)));
            PaymentPeriodText.setText(String.valueOf(dtm3.getValueAt(infoTable3.getSelectedRow(), 11)));
            PurDateCombo.setSelectedItem(dtm3.getValueAt(infoTable3.getSelectedRow(), 8));
    ...
    private void infoTable3MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_infoTable3MouseEntered

    }//GEN-LAST:event_infoTable3MouseEntered
